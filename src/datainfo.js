const datainfo = {
  tiles: ["https://omt.map-hosting.de/data/v3/{z}/{x}/{y}.pbf"],
  name: "OpenMapTiles",
  format: "pbf",
  basename: "2021.09.18.germany.mbtiles",
  id: "openmaptiles",
  pixel_scale: "256",
  vector_layers: [
    {
      ...
      minzoom: 0,
      maxzoom: 14,
      fields: { class: "String", intermittent: "Number", brunnel: "String" },
    },
    {
      id: "waterway",
      description:
  ...
  bounds: [5.845, 47.25, 15.06, 55.12],
  center: [10.5, 51.2, 1],
  minzoom: 0,
  maxzoom: 14,
  attribution:
